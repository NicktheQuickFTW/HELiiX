...
import { Card, Tabs, Button } from '@once-ui-system/core';
import { Badge, Input, Text } from '@once-ui-system/core';
// Note: Progress, Alert, and ScrollArea components need Once UI implementation
import { 
  FileText, 
  Shield, 
  BookOpen,
