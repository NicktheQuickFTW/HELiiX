      ...
      <Column gap="xl" padding="l" paddingTop="m">
          ...
          <Flex gap="m" style={{ alignItems: 'center' }}>
            ...
            <Column>
              <Heading variant="display-strong-l">
                Big 12 Analytics Dashboard
              </Heading>
              <Text variant="body-default-m">
                Comprehensive data insights and performance metrics across all
        ...
        <Grid columns="6" gap="m">
          <Card padding="m">
            ...
            <Text variant="body-default-xs">+12% from last month</Text>
          </Card>
          <Card padding="m">
            <Flex
              justifyContent="between"
            ...
            <Text variant="body-default-xs">+3 from last season</Text>
          </Card>
          <Card padding="m">
            <Flex
              justifyContent="between"
            ...
            <Text variant="body-default-xs">$290K of $485K</Text>
          </Card>
          <Card padding="m">
            <Flex
              justifyContent="between"
            ...
            <Text variant="body-default-xs">+5% improvement</Text>
          </Card>
          <Card padding="m">
            <Flex
              justifyContent="between"
            ...
            <Text variant="body-default-xs">Above SLA target</Text>
          </Card>
          <Card padding="m">
            <Flex
              justifyContent="between"
            ...
            <Text variant="body-default-xs">Nationally ranked</Text>
          </Card>
        </Grid>
        ...
        <Card padding="l">
          <Column gap="m">
            ...
            <Text variant="body-default-m">
              Manage data sources, refresh intervals, and export options for
            ...
            <Flex gap="l" style={{ alignItems: 'center' }}>
              ...
              <Flex gap="s" style={{ alignItems: 'center' }}>
                ...
                <Text variant="body-default-s">
                  Data Sources: Notion, Supabase, Internal APIs
                </Text>
              </Flex>
            </Flex>
          </Column>
                  ...
                  <Column gap="m">
                    ...
                    <Column gap="s">
                      {[
                        ...
                        {
                          org: 'Kansas Athletics',
                          contacts: 38,
                          change: '+8%',
                        },
                        {
                          org: 'Iowa State Athletics',
                          contacts: 32,
                          change: '+5%',
                        },
                        { org: 'Oklahoma State', contacts: 29, change: '+15%' },
                        {
                          org: 'Baylor Athletics',
                          contacts: 27,
                          change: '+3%',
                        },
                      ].map((item, index) => (
                ...
                <Card padding="l">
                  <Column gap="m">
                    ...
                    <Column gap="s">
                      {[
                        {
                          resource: 'Staff Productivity',
                          utilization: '91%',
                          status: 'optimal',
                        },
                        {
                          resource: 'Technology Assets',
                          utilization: '87%',
                          status: 'good',
                        },
                        {
                          resource: 'Facility Usage',
                          utilization: '94%',
                          status: 'optimal',
                        },
                        {
                        ...
                        >
                          ...
                          <Badge
                            variant={
                              item.status === 'optimal' ? 'accent' : 'secondary'
                            }
                            style={
                              item.status === 'optimal'
                                ? { color: '#10b981' }
          ...
          <Column gap="l">
            ...
            <Grid columns="3" gap="xl">
              <Column gap="s">
                ...
                <Column gap="xs">
                  <Text variant="body-default-s">
                    • #1 conference ranking nationally
                  </Text>
                  <Text variant="body-default-s">
                    • 99.8% system uptime exceeds SLA
                  </Text>
                  <Text variant="body-default-s">
                    • 94% event completion rate
                  </Text>
                  <Text variant="body-default-s">
                    • Strong revenue growth (+18% TV)
                  </Text>
                </Column>
              </Column>
              <Column gap="s">
                ...
                <Column gap="xs">
                  <Text variant="body-default-s">
                    • Expand contact database (+12% growth)
                  </Text>
                  <Text variant="body-default-s">
                    • Automate remaining manual processes
                  </Text>
                  <Text variant="body-default-s">
                    • Increase championship success rate
                  </Text>
                  <Text variant="body-default-s">
                    • Optimize Technology budget allocation
                  </Text>
                </Column>
              </Column>
              <Column gap="s">
                ...
                <Column gap="xs">
                  ...
                  <Text variant="body-default-s">
                    • Enhance member school relations
                  </Text>
                  <Text variant="body-default-s">
                    • Invest in championship programs
                  </Text>
                </Column>
              </Column>
            </Grid>
