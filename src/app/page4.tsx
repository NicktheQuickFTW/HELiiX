  ...
  return (
    <div
      style={{
        ...
        borderRadius: '50%',
        background:
          'radial-gradient(circle at 30% 30%, var(--accent-solid-strong) 0%, var(--brand-solid-strong) 50%, var(--neutral-background-strong) 100%)',
        position: 'relative',
      ...
      >
        ...
        <Fade duration="m">
          <Row fillWidth horizontal="space-between" alignItems="center">
            <Column gap="8">
              <Heading variant="display-strong-l">Command Center</Heading>
              <Row gap="8" alignItems="center">
                      ...
                      <Row gap="4" alignItems="center">
                        <div
                          style={{
                            ...
                            height: '8px',
                            borderRadius: '50%',
                            background: 'var(--yellow-solid-strong)',
                          }}
                        />
