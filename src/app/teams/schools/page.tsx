...
const teams = [
  {
    ...
    sports: 18,
    facilities: ["Allen Fieldhouse", "David Booth Kansas Memorial Stadium", "Hoglund Ballpark"],
    recentAchievements: ["2022 NCAA Basketball Champions", "2023 Big 12 Regular Season Champions"],
  },
  {
    id: "houston",
    ...
    recentAchievements: ["2023 AAC Tournament Champions", "2023 NCAA Final Four"],
  },
  {
    id: "baylor",
    name: "Baylor Bears",
    ...
    recentAchievements: ["2021 NCAA Basketball Champions", "2021 Big 12 Tournament Champions"],
  },
  {
    id: "texas_tech",
    ...
    sports: 17,
    facilities: ["United Supermarkets Arena", "Jones AT&T Stadium", "Dan Law Field"],
    recentAchievements: ["2019 NCAA Basketball Runner-up", "2023 Big 12 Baseball Champions"],
  },
              ...
              <Grid columns={2} gap="s">
                ...
                >
                  <Column gap="xs" alignItems="center">
                    <Text variant="label-default-xs" style={{ color: "rgba(255,255,255,0.8)" }}>
                      Championships
                    </Text>
            ...
            <>
              <Grid columns={2} gap="m">
                <Column gap="xs">
                  ...
                  <Heading variant="heading-strong-m">{team.stats.overallRecord}</Heading>
                </Column>
                <Column gap="xs">
                  <Text variant="label-default-s" onBackground="neutral-medium">
                    National Championships
                  </Text>
                  <Heading variant="heading-strong-m">{team.stats.nationalChampionships}</Heading>
                </Column>
              </Grid>
            ...
            <Column gap="m">
              {team.recentAchievements.map((achievement, index) => (
                <Row key={index} gap="s" vertical="center">
                  <Icon name="trophy" size="s" style={{ color: "var(--warning)" }} />
      ...
      <Column fillWidth gap="xl" padding="l">
        ...
        <RevealFx speed="medium">
          <Grid columns={{ base: 1, s: 2, l: 4 }} gap="m">
            {[
              { label: "Total Enrollment", value: "576K+", icon: "users", color: "var(--brand-electric-500)" },
              { label: "Combined Championships", value: "193", icon: "trophy", color: "var(--warning)" },
              { label: "Athletic Programs", value: "286", icon: "activity", color: "var(--brand-purple-500)" },
              { label: "Annual Revenue", value: "$2.8B", icon: "dollar-sign", color: "var(--success)" },
            ].map((stat, index) => (
              <Card
                key={index}
                padding="m"
              ...
              >
                <Column gap="s" alignItems="center">
                  <Icon name={stat.icon as any} size="m" style={{ color: stat.color }} />
                  <GlitchFx trigger="hover" speed="fast">
                    <Heading variant="display-strong-s" style={{ color: stat.color }}>
                      {stat.value}
                    </Heading>
                  </GlitchFx>
                  <Text variant="label-default-s" onBackground="neutral-medium">
          ...
          >
            ...
            <Row horizontal="center" vertical="center" padding="l">
              <Column gap="m" alignItems="center" maxWidth="l">
                ...
                >
                  16 schools. One conference. Unlimited potential. Together, we're shaping the future of collegiate athletics.
                </Text>
