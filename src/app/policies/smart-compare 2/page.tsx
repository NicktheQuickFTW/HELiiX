...
const COMPARISON_TOPICS = [
  {
    ...
    query:
      'Compare the weather postponement policies and procedures across sports',
  },
  {
    id: 'officiating',
    ...
    query:
      'Compare officiating procedures, assignments, and evaluation processes',
  },
  {
    id: 'championship',
    ...
    query:
      'Compare championship selection criteria, tournament formats, and qualification procedures',
  },
  {
    id: 'media',
    ...
    query:
      'Compare media relations policies including timeouts, interviews, and broadcasting requirements',
  },
  {
    id: 'equipment',
    ...
    query:
      'Compare equipment specifications, uniform requirements, and safety standards',
  },
  {
    id: 'eligibility',
    ...
    query:
      'Compare student-athlete eligibility requirements, roster procedures, and verification processes',
  },
];
  ...
  const toggleSport = (sport: string) => {
    setSelectedSports((prev) => {
      if (prev.includes(sport)) {
        ...
        // Limit to 4 sports for better comparison
        return [...prev, sport];
      }
      return prev;
    });
      ...
      <Row fillWidth justifyContent="space-between" alignItems="center">
        <Column gap="xs">
          ...
          <Text variant="body-default-s" onBackground="neutral-weak">
            AI-powered cross-sport policy analysis using Gemini Pro deep
            research
          </Text>
        </Column>
        <Row gap="s">
        ...
        <Column gap="m">
          <Row justifyContent="space-between" alignItems="center">
            <Text variant="heading-strong-s">
              Select Sports to Compare (2-4 sports)
            </Text>
          ...
          <Row gap="xs" wrap>
            {SPORTS_OPTIONS.map((sport) => (
              <Button
                ...
                disabled={
                  !selectedSports.includes(sport) && selectedSports.length >= 4
                }
              >
                {sport}
              </Button>
          ...
          <Column gap="s">
            ...
            <Row justifyContent="space-between" alignItems="center">
              ...
              <Button
                ...
                disabled={
                  !customQuery.trim() || selectedSports.length < 2 || isLoading
                }
              >
        ...
        <Card padding="m" background="surface" border="neutral-medium">
          <Row justifyContent="center" alignItems="center" gap="m">
            <Text variant="body-default-s">
              🤖 AI analyzing policies across {selectedSports.join(', ')}...
            </Text>
          </Row>
        </Card>
      )}
        ...
        <Column gap="m">
          ...
          <Grid columns="3" gap="m">
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Gemini Pro analyzes complete manual content to identify nuanced
            ...
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Identifies patterns, inconsistencies, and best practices across
                different sports policies
              </Text>
            </Column>
            ...
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Provides recommendations for policy standardization and
