...
const demoPolicies = [
  {
    ...
    status: 'current',
    summary:
      'Standardized procedures for television timeouts during football games',
  ...
  },
  {
    ...
    status: 'current',
    summary:
      'Guidelines for postponing soccer matches due to weather conditions',
  ...
  },
  {
    ...
    status: 'current',
    summary:
      'Standardized travel reimbursement procedures across all Big 12 sports',
...
export default function PolicyDemoPage() {
  ...
  const filteredPolicies = demoPolicies.filter((policy) => {
    ...
    if (
      selectedSport &&
      policy.sport !== selectedSport &&
      policy.sport !== 'All Sports'
    )
      return false;
    return true;
  });
    ...
    <Column fillWidth gap="l" padding="xl">
      ...
      <Row fillWidth justifyContent="space-between" alignItems="center">
        <Column gap="xs">
          <Heading variant="display-strong-s">
            Policy Management System Demo
          </Heading>
          <Text variant="body-default-s" onBackground="neutral-weak">
            Demonstration of Big 12 Conference policy tracking and comparison
            capabilities
          </Text>
        </Column>
        <Row gap="s">
          <Button
            variant="primary"
            size="m"
            onClick={() => (window.location.href = '/policies/ai-assistant')}
          >
            🤖 AI Assistant
          </Button>
          <Button
            variant="primary"
            size="m"
            onClick={() => (window.location.href = '/policies/smart-compare')}
          >
            ⚖️ Smart Compare
          </Button>
          <Button
            ...
            size="m"
            onClick={() =>
              (window.location.href = '/policies/category-manager')
            }
          >
            📋 Categories
          </Button>
          <Button
            ...
            size="m"
            onClick={() =>
              (window.location.href = '/policies/analyze-sections')
            }
          >
            📊 Analysis
          </Button>
      ...
      <Grid columns="4" gap="m">
        <Card padding="m" background="surface" border="neutral-medium">
          <Column gap="xs">
            <Text variant="heading-strong-l">
              {demoAnalysisData.totalCategories}
            </Text>
            <Text variant="body-default-s" onBackground="neutral-weak">
              Policy Categories
            </Text>
        ...
        <Card padding="m" background="surface" border="neutral-medium">
          <Column gap="xs">
            <Text variant="heading-strong-l">
              {Object.keys(demoAnalysisData.categoriesBySport).length}
            </Text>
            <Text variant="body-default-s" onBackground="neutral-weak">
              Sports Analyzed
            </Text>
          ...
          <Row gap="m" wrap>
            <Column gap="s">
              ...
              <Row gap="xs" wrap>
                ...
                {Object.keys(demoAnalysisData.categoryCount)
                  .slice(0, 6)
                  .map((category) => (
                    <Button
                      key={category}
            ...
            <Column gap="s">
              ...
              <Row gap="xs" wrap>
                ...
                {['Football', 'Basketball', 'Soccer', 'Baseball'].map(
                  (sport) => (
                    <Button
                      key={sport}
                      variant={
      ...
      <Card padding="m" background="surface" border="neutral-medium">
        <Column gap="m">
          <Text variant="heading-strong-s">
            Category Distribution Across Sports
          </Text>
          <Grid columns="1" gap="s">
      ...
      <Card padding="m" background="surface" border="neutral-medium">
        <Column gap="m">
          ...
          <Grid columns="1" gap="s">
            {Object.entries(demoAnalysisData.categoriesBySport)
              .slice(0, 6)
        ...
        <Column gap="m">
          ...
          <Grid columns="2" gap="m">
            <Column gap="s">
              ...
              <Column gap="xs">
                <Text variant="body-default-s">
                  • PDF section analysis and categorization
                </Text>
                <Text variant="body-default-s">
                  • Sport-specific content extraction
                </Text>
                <Text variant="body-default-s">
                  • Granular policy categorization (30+ categories)
                </Text>
                <Text variant="body-default-s">
                  • Cross-sport comparison framework
                </Text>
                <Text variant="body-default-s">
                  • Once UI compliant interface
                </Text>
                <Text variant="body-default-s">
            ...
            <Column gap="s">
              ...
              <Column gap="xs">
                <Text variant="body-default-s">
                  • NotebookLM-style AI query system with Gemini Pro
                </Text>
                <Text variant="body-default-s">
                  • Custom category creation and analysis (e.g., Video Replay)
                </Text>
                <Text variant="body-default-s">
                  • Deep research and document analysis
                </Text>
                <Text variant="body-default-s">
                  • Intelligent cross-sport policy comparison
                </Text>
                <Text variant="body-default-s">
                ...
                <Text variant="body-default-s">
                  • Advanced policy analysis modes
                </Text>
                <Text variant="body-default-s">
      ...
      <Card padding="m" background="brand-weak" border="brand-medium">
        <Column gap="m">
          <Row alignItems="center" gap="s">
            <Text variant="heading-strong-s">
              🚀 NEW: AI-Powered Manual Analysis
            </Text>
            <Badge variant="brand" size="s">
          ...
          <Text variant="body-default-s">
            Experience NotebookLM-style AI capabilities for Big 12
            administrative manuals. Ask questions, run comparisons, and get deep
            insights from all 9 sport manuals using advanced AI research
            capabilities.
          </Text>
          ...
          <Grid columns="4" gap="m">
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Conversational interface for asking questions about policies,
                procedures, and manual content
              </Text>
            </Column>
            ...
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                AI-powered cross-sport policy comparison with deep analysis and
                recommendations
              </Text>
            </Column>
            ...
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Create custom policy categories like "Video Replay" and analyze
                them across all sports
              </Text>
            </Column>
            ...
            <Column gap="s">
              ...
              <Text variant="body-default-s">
                Gemini Pro analyzes complete manual content for comprehensive
