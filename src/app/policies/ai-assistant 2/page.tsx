...
const QUERY_MODES = [
  {
    ...
    description: 'Ask any question about policies or procedures',
  },
  {
    value: 'comparison',
    label: 'Cross-Sport Comparison',
    description: 'Compare policies across different sports',
  },
  {
    value: 'summary',
    label: 'Policy Summary',
    description: 'Get organized summaries of complex policies',
  },
  {
    value: 'policy-analysis',
    label: 'Deep Analysis',
    description: 'Analyze implications and compliance requirements',
  },
];
...
const EXAMPLE_QUERIES = [
  ...
  {
    question:
      'How do officiating procedures differ between Football and Basketball?',
  ...
  {
    question:
      'Analyze the media timeout policies across basketball and football',
    sports: ['Football', 'Basketball'],
      ...
      <Row fillWidth justifyContent="space-between" alignItems="center">
        <Column gap="xs">
          ...
          <Text variant="body-default-s" onBackground="neutral-weak">
            Ask questions, compare policies, and get insights from Big 12
          ...
          <Column gap="m">
              ...
              <Row gap="xs" wrap>
                {QUERY_MODES.map((mode) => (
                  <Button
                    key={mode.value}
                    variant={
                      selectedMode === mode.value ? 'primary' : 'secondary'
                    }
                    size="s"
            ...
            <Column gap="s">
              ...
              <Row gap="xs" wrap>
                <Button
                  variant={
                    selectedSports.length === 0 ? 'primary' : 'secondary'
                  }
                  size="s"
                ...
                {SPORTS_OPTIONS.map((sport) => (
                  <Button
                    key={sport}
                    variant={
                      selectedSports.includes(sport) ? 'primary' : 'secondary'
                    }
                    size="s"
              ...
              <Column gap="m" style={{ maxHeight: '600px', overflowY: 'auto' }}>
                {messages.map((message) => (
                  <Card
                    ...
                    padding="s"
                    background={
                      message.type === 'user' ? 'brand-weak' : 'neutral-weak'
                    }
                    border="neutral-medium"
                  >
                    <Column gap="s">
                      <Row justifyContent="space-between" alignItems="center">
                        <Row gap="xs" alignItems="center">
                          <Badge
                            variant={
                              message.type === 'user' ? 'brand' : 'neutral'
                            }
                            size="xs"
                          >
                          ...
                          <Row gap="xs" wrap>
                            {message.sources.map((source, idx) => (
                              <Badge key={idx} variant="neutral" size="xs">
                                {source.sport} ({source.relevantSections}{' '}
                                sections)
                              </Badge>
                            ))}
                          </Row>
            ...
            <Grid columns="2" gap="m">
              <Column gap="s">
                ...
                <Text variant="body-default-s">
                  Powered by Gemini Pro for comprehensive document analysis and
                  cross-referencing across all Big 12 administrative manuals
                </Text>
              </Column>
              ...
              <Column gap="s">
                ...
                <Text variant="body-default-s">
                  Compare policies, procedures, and requirements across
                  different sports with detailed analysis of similarities and
                  differences
                </Text>
              </Column>
              ...
              <Column gap="s">
                ...
                <Text variant="body-default-s">
                  Identify patterns, inconsistencies, and optimization
                  opportunities across manual content with AI-powered insights
                </Text>
              </Column>
              ...
              <Column gap="s">
                ...
                <Text variant="body-default-s">
                  Get specific citations, operational implications, and
                  actionable recommendations based on official manual content
                </Text>
              </Column>
            </Grid>
          </Column>
