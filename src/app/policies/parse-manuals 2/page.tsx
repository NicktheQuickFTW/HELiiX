      ...
      <Column fillWidth gap="l" padding="xl">
        ...
        >
          ...
          <Text variant="body-default-m">
            Loading administrative manuals...
          </Text>
        </Row>
      </Column>
    );
      ...
      <Card padding="m" background="surface" border="neutral-medium">
        <Column gap="s">
          ...
          <Text variant="body-default-s" onBackground="neutral-medium">
            This process will extract only sport-specific policy sections with
          ...
          <Column gap="xs" style={{ marginLeft: '16px', marginTop: '8px' }}>
            <Text variant="body-strong-s" onBackground="warning-medium">
              ✗ Will Skip:
            </Text>
            <Text variant="body-default-s">
            ...
            <Text variant="body-default-s">
              • Conference Rules (provided separately)
            </Text>
          ...
          >
            Only sections with substantial policy text and regulatory language
            will be extracted.
          </Text>
        </Column>
      </Card>
