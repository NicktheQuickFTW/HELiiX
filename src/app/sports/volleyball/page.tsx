...
const volleyballTeams = [
  ...
  { school: "Arizona State", record: "18-13", ranking: "NR", conference: "9-9" },
  { school: "Colorado", record: "17-14", ranking: "NR", conference: "8-10" },
  { school: "Oklahoma State", record: "16-15", ranking: "NR", conference: "7-11" },
  { school: "West Virginia", record: "15-16", ranking: "NR", conference: "6-12" },
    ...
    <div className="flex-1 space-y-8 p-8 pt-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Big 12 Volleyball</h1>
            <p className="text-muted-foreground">
              Elite volleyball competition featuring nationally ranked programs and NCAA Tournament contenders.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Badge className="bg-accent text-accent-foreground">Round Robin Format</Badge>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Conference Matches</CardTitle>
            ...
            {volleyballTeams.map((team, index) => (
              <div 
                ...
                className={`flex items-center justify-between p-3 rounded-lg border ${
                  index < 6 ? 'bg-accent/10 border-accent/20' : 'hover:bg-muted/50'
                }`}
              >
                <div className="flex items-center space-x-4">
