...
export default function CredentialDisplayPage() {
  ...
  const isCredentialValid = () => {
    ...
    return (
      credential.status === 'active' && now >= validFrom && now <= validUntil
    );
  };
        ...
        <Card>
          <Column className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              The requested credential could not be found or you don't have
  ...
  return (
    <div className="container py-6 space-y-6">
      ...
      {/* Status Alert */}
      <Card
        className={`border-l-4 ${isCredentialValid() ? 'border-l-green-500 bg-green-50' : 'border-l-red-500 bg-red-50'}`}
      >
        <Column className="pt-6">
          <div className="flex items-center gap-2">
            ...
            <span
              className={`font-medium ${isCredentialValid() ? 'text-green-800' : 'text-red-800'}`}
            >
              {isCredentialValid()
                ? 'Credential is valid and active'
                : 'Credential is not currently valid'}
            </span>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <Card>
            <Column gap="xs">
              <Heading variant="heading-sm">Digital Credential</Heading>
              <Text variant="body-sm" muted>
                Present this credential for venue access
              </Text>
            </Column>
            <Column>
              {/* Credential Card */}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <Badge
                      className={`${getStatusColor(credential.status)} print:bg-gray-200 print:text-black`}
                    >
                      {credential.status.toUpperCase()}
                    </Badge>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg">
                      {credential.credential_requests.first_name}{' '}
                      {credential.credential_requests.last_name}
                    </h4>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {credential.championship_events.venue_name}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {formatAccessLevels(credential.access_levels).map(
                      (level, index) => (
                        <span
                          key={index}
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <Column className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {credential.championship_events.sport
                    .replace('_', ' ')
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {credential.championship_events.city},{' '}
                    {credential.championship_events.state}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {new Date(
                      credential.championship_events.start_date
                    ).toLocaleDateString()}{' '}
                    -{' '}
                    {new Date(
                      credential.championship_events.end_date
                    ).toLocaleDateString()}
                  </p>
                </div>
              </div>
          ...
          <Card>
            <Column gap="xs">
              <Heading variant="heading-sm">Usage Instructions</Heading>
            </Column>
