...
const credentialTypes = [
  { value: 'media', label: 'Media', description: 'Press, journalists, photographers' },
  { value: 'official', label: 'Official', description: 'Referees, game officials' },
  ...
  { value: 'photographer', label: 'Photographer', description: 'Professional photographers' },
  { value: 'broadcaster', label: 'Broadcaster', description: 'TV, radio, streaming' }
]

const accessLevels = [
  { value: 'field_access', label: 'Field Access', description: 'Access to playing field' },
  { value: 'sideline_access', label: 'Sideline Access', description: 'Access to team sidelines' },
  { value: 'press_box', label: 'Press Box', description: 'Media press box access' },
  { value: 'interview_room', label: 'Interview Room', description: 'Post-game interviews' },
  { value: 'locker_room', label: 'Locker Room', description: 'Team locker room access' },
  { value: 'restricted_areas', label: 'Restricted Areas', description: 'Staff-only areas' },
  { value: 'general_admission', label: 'General Admission', description: 'Public seating areas' },
  { value: 'backstage', label: 'Backstage', description: 'Behind-scenes areas' },
  { value: 'venue_perimeter', label: 'Venue Perimeter', description: 'Venue exterior areas' },
...
export default function CredentialRequestPage() {
  ...
  const handleAccessLevelToggle = (accessLevel: string) => {
    setFormData(prev => ({
      ...prev,
      requested_access_levels: prev.requested_access_levels.includes(accessLevel)
      ...
      <div className="container py-6">
        <div className="flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">Loading request form...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="container py-6">
        <Card>
          <CardContent className="text-center py-8">
            ...
            <h3 className="text-lg font-medium mb-2">Credential Deadline Passed</h3>
            <p className="text-muted-foreground mb-4">
                ...
                <div className="grid gap-2">
                  {credentialTypes.map((type) => (
                    <div
                      ...
                      onClick={() => setFormData({...formData, credential_type: type.value})}
                    >
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          name="credentialType"
                          value={type.value}
                          checked={formData.credential_type === type.value}
                          readOnly
                        />
                        <div>
                ...
                <div className="grid gap-2 md:grid-cols-2">
                  {accessLevels.map((level) => (
                    <div key={level.value} className="flex items-start space-x-2">
                      <Checkbox
                        id={level.value}
                        checked={formData.requested_access_levels.includes(level.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({
                      ...formData,
                      vehicle_info: {...formData.vehicle_info, license_plate: e.target.value}
                    })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({
                      ...formData,
                      vehicle_info: {...formData.vehicle_info, make: e.target.value}
                    })}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({
                      ...formData,
                      vehicle_info: {...formData.vehicle_info, model: e.target.value}
                    })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({
                      ...formData,
                      vehicle_info: {...formData.vehicle_info, color: e.target.value}
                    })}
