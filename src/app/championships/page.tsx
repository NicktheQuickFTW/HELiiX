            ...
            {event.broadcast && (
              <Row gap="s">
                ...
                {event.broadcast.map((channel, index) => (
                  <Tag key={index} size="xs" variant="neutral">
                    {channel}
                  </Tag>
                ))}
              </Row>
                  ...
                  <Row gap="m" vertical="center">
                    ...
                    <HoloFx shine={{ opacity: 80 }}>
                      <Badge variant="danger" size="l">
                        <StatusIndicator variant="danger" size="s" />3 LIVE
                        EVENTS
                      </Badge>
                    </HoloFx>
                  </Row>
          ...
          >
            ...
            <Row horizontal="space-between" vertical="center" wrap gap="l">
              <Column gap="s" flex={1}>
                ...
                >
                  Get real-time insights, automated scheduling, and predictive
                  analytics for all championship events
                </Text>
              </Column>
